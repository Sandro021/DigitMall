...
fun HomeHeader() {
    Column(
        modifier = Modifier
            ...
            .padding(
                start = Padding.padding24,
                end = Padding.padding24,
                top = Padding.padding48,
                bottom = Padding.padding24
            )
    ) {
        ...
        Text(
            text = "Find your favorite brands",
            color = Color.White.copy(alpha = 0.8f),
            style = MallTheme.typography.productTitle.copy(fontSize = 16.sp)
        )
